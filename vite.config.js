...
export default defineConfig(async ({ mode }) => {
    ...
    try {
      ...
      plugins.push(federation({
        ...
        exposes: {
          ...
          './CidsCard': './src/components/CidsCard.vue',
          ...
          './PortalHeader': './src/components/PortalHeader.vue',
  ...
  return {
    ...
    plugins,
    resolve: {
      alias: (mode === 'test' || process.env.VITEST === 'true') ? [
    ...
    test: {
      ...
      coverage: {
        ...
        include: ['src/{theme,http,i18n,storage,error,audit,formkit,regionalization,cache,bus,api}/**/*.{ts,vue}'],
