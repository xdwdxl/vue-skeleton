...
<script setup lang="ts">
  /**
   * @component PortalSvgIcon - SVG sprite icon component
   * @author Vicky Zhu
   * @date 2026-03-16
  ...
  defineOptions({ name: 'PortalSvgIcon' })
